 ...
 */
!function(t,e){"object"==typeof exports&&"object"==typeof module?module.exports=e(require("underscore"),require("jquery")):"function"==typeof define&&define.amd?define(["underscore","jquery"],e):"object"==typeof exports?exports.MapiWkt=e(require("underscore"),require("jquery")):t.MapiWkt=e(t._,t.jQuery)}(this,function(t,e){return function(t){function e(n){if(o[n])return o[n].exports;var r=o[n]={exports:{},id:n,loaded:!1};return t[n].call(r.exports,r,r.exports,e),r.loaded=!0,r.exports}var o={};return e.m=t,e.c=o,e.p="",e(0)}([function(t,e,o){"use strict";function n(t,e){var o={};for(var n in t)e.indexOf(n)>=0||Object.prototype.hasOwnProperty.call(t,n)&&(o[n]=t[n]);return o}var r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t},s=(o(4),o(3)),i=window.Wkt;window.Wkt=o(1),o(2),Array.isArray||(Array.isArray=function(t){return"[object Array]"===Object.prototype.toString.call(t)});var p={wkt:Wkt,addObjectFromWKT:function(t){var e=t.groupId,o=void 0===e?"wkt":e,i=t.id,p=void 0===i?s.uniqueId("wkt"):i,a=t.wkt,g=t.content,l=n(t,["groupId","id","wkt","content"]),c=this;a="object"===("undefined"==typeof a?"undefined":r(a))?JSON.stringify(a):a.replace("\n","").replace("\r","").replace("\t","");var u=new this.wkt.Wkt;u.read(a);var h=u.toObject(l),y=function(t,e){t.setMap(c.map),t.mapiOptions=t.mapiOptions||{},t.mapiOptions.content=g,e?c.addObject({groupId:o,id:p+"_"+e,object:t}):c.addObject({groupId:o,id:p,object:t}),l.onClick&&google.maps.event.addListener(t,"click",l.onClick),l.tooltip&&this.addTooltip(t,l.tooltip,l.tooltipCss)};return Array.isArray(h)?s(h).each(y):y(h),h},getWKTFromObject:function(t){var e=t.groupId,o=t.id,n=new this.wkt.Wkt;if(!o){var r={};return s.each(this.objects[e],function(t,e){n.fromObject(t),r[e]=n.write()}),r}if(this.objects[e][o])return n.fromObject(this.objects[e][o]),n.write()}};window.Wkt=i,t.exports=p},function(t,e,o){var n;/** @license
	 *
