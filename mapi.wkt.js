...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["MapiWkt"] = factory(require("jquery"), require("underscore"));
	else
		root["MapiWkt"] = factory(root["jQuery"], root["_"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MapiWkt = {
		...
		addObjectFromWKT: function addObjectFromWKT(_ref) {
			var _ref$groupId = _ref.groupId;
			var groupId = _ref$groupId === undefined ? 'wkt' : _ref$groupId;
			var _ref$id = _ref.id;
			...
			if ((typeof wkt === 'undefined' ? 'undefined' : _typeof(wkt)) === 'object') {
			...
			var addObject = function addObject(object, idx) {
				...
				if (idx) {
					...
					mapi.addObject({ groupId: groupId, id: id, object: object });
				}
		...
		getWKTFromObject: function getWKTFromObject(_ref2) {
